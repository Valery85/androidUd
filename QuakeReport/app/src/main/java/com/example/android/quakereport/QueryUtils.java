...
public final class QueryUtils {
    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            //Create JSONObject from the given string SAMPLE_JSON_RESPONSE
            JSONObject jsonRootObject = new JSONObject (SAMPLE_JSON_RESPONSE);

            // Get JSONArray which is value of key "feature"
            ...
            for(int i=0; i<jsonArray.length(); i++){
                ...
                JSONObject jsonObjectFeature = jsonArray.getJSONObject(i);

                // Get JSONObject wich is value for key properties
